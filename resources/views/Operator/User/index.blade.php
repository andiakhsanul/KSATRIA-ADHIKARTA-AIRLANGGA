...
@section('content')
    ...
    <div class="mb-8 flex flex-col sm:flex-row gap-5 sm:items-center sm:justify-between bg-white p-4 rounded-lg shadow-sm">
        ...
        <div class="flex gap-3 mt-3 sm:mt-0">
            <form method="GET" class="flex gap-3">
                <select name="role_id"
                    class="border border-gray-300 rounded-lg px-3 py-2.5 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-gray-700 bg-gray-50 cursor-pointer hover:bg-gray-100 transition-colors duration-200">
                ...
                <button type="submit"
                    class="bg-gray-100 text-gray-700 px-4 py-2.5 rounded-lg hover:bg-gray-200 flex items-center gap-2 transition-colors duration-200 shadow-sm border border-gray-200">
    ...
    <div class="bg-white rounded-lg shadow-md overflow-x-auto">
        <div class="min-w-max">
            <table class="w-full" id="tableBody">
                <thead>
